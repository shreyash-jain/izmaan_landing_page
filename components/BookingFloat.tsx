...
// Always-visible "Book on Booking.com" button (bottom-right), in Booking.com's
...
export function BookingFloat() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full bg-[#003580] px-4 py-3 shadow-lift transition hover:scale-105 hover:bg-[#00224f]"
    >
      {/* Booking.com "B." app-icon glyph */}
